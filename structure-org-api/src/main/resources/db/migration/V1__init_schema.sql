...
CREATE UNIQUE INDEX uk_org_code ON organization(code);
...
CREATE INDEX idx_dept_org_id ON dept(organization_id);
...
CREATE INDEX idx_member_state ON member(state);
...
CREATE INDEX idx_request_org_user ON member_request(organization_id, user_id);
CREATE INDEX idx_request_state ON member_request(state);
CREATE INDEX idx_request_invite_link ON member_request(invite_link_id);
...
CREATE UNIQUE INDEX uk_il_invite_code ON invite_link(invite_code);
CREATE INDEX idx_il_org_id ON invite_link(organization_id);
CREATE INDEX idx_il_state ON invite_link(state);
...
CREATE INDEX idx_mi_invite_phone ON member_invite(invite_phone);
CREATE INDEX idx_mi_invite_code ON member_invite(invite_code);
CREATE INDEX idx_mi_org_id ON member_invite(organization_id);
CREATE INDEX idx_mi_state ON member_invite(state);
